...
From the 'fastapi-microservices' project directory, open the **fastapi-deployment.yaml** in a text editor and find the section that defines the resources for the **web** container:
```bash
        resources:
          requests:
            cpu: "100m"
